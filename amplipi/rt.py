...
class _Preamps:
  ...
  # In-place preamp recovery (rt patch) — rate-limited so a benign I2C glitch
  ...
  def _recover_preamps(self) -> bool:
    """ Recover a wedged/hung preamp IN-PLACE (rt patch).
    ...
    if self.bus is not None:
      try:
        ...
        try:
          ...
          # Fallback 2 (rt patch): a reopened fd can't revive a hung preamp MCU.
